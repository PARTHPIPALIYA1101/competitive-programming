...
This repository contains **171** accepted Java solutions for various Codeforces problems, organized by topic.
...
| [Math/](./Math/) | **Math** | **42** | Number theory, divisibility, geometry, formulas, modular arithmetic, ceiling/floor math. |
