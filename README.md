...
This repository contains **175** accepted Java solutions for various Codeforces problems, organized by topic.

## 📌 Repository Structure

The solutions are organized into the following topic subdirectories:
...
| [Math/](./Math/) | **Math** | **44** | Number theory, divisibility, geometry, formulas, modular arithmetic, ceiling/floor math. |
...
- [AColorfulStonesSimplifiedEdition.java](./Implementation/AColorfulStonesSimplifiedEdition.java)
- [AFloorNumber.java](./Implementation/AFloorNumber.java)
- [AFreeIceCream.java](./Implementation/AFreeIceCream.java)
- [AGames.java](./Implementation/AGames.java)
- [AGennadyAndACardGame.java](./Implementation/AGennadyAndACardGame.java)
...
- [AStonesOnTheTable.java](./Implementation/AStonesOnTheTable.java)
- [ASumOfRoundNumbers.java](./Implementation/ASumOfRoundNumbers.java)
- [AVanyaAndFence.java](./Implementation/AVanyaAndFence.java)
- [AVusTheCossackAndAContest.java](./Implementation/AVusTheCossackAndAContest.java)
- [AWord.java](./Implementation/AWord.java)
- [AYesYes.java](./Implementation/AYesYes.java)
- [BAtillaSFavoriteProblem.java](./Implementation/BAtillaSFavoriteProblem.java)
- [BColourblindness.java](./Implementation/BColourblindness.java)
- [BEvenArray.java](./Implementation/BEvenArray.java)
...
- [AMinimalSquare.java](./Math/AMinimalSquare.java)
...
- [ATwoVessels.java](./Math/ATwoVessels.java)
- [AVasyaAndCoins.java](./Math/AVasyaAndCoins.java)
- [AYetAnotherTwoIntegersProblem.java](./Math/AYetAnotherTwoIntegersProblem.java)
- [AYogurtSale.java](./Math/AYogurtSale.java)
- [AZeroSum.java](./Math/AZeroSum.java)
- [BAdd0OrK.java](./Math/BAdd0OrK.java)
...
- [AFlipFlops.java](./Greedy/AFlipFlops.java)
- [AFoodForAnimals.java](./Greedy/AFoodForAnimals.java)
- [AForked.java](./Greedy/AForked.java)
- [AGoalsOfVictory.java](./Greedy/AGoalsOfVictory.java)
- [AGrasshopperOnALine.java](./Greedy/AGrasshopperOnALine.java)
- [AKoshary.java](./Greedy/AKoshary.java)
...
- [BEzraftAndArray.java](./Greedy/BEzraftAndArray.java)
- [BHeapify1.java](./Greedy/BHeapify1.java)
- [BKarSalesman.java](./Greedy/BKarSalesman.java)
...
- [BYourName.java](./Greedy/BYourName.java)
- [CAdvantage.java](./Greedy/CAdvantage.java)
- [COddEvenIncrements.java](./Greedy/COddEvenIncrements.java)
- [CRemoveSmallest.java](./Greedy/CRemoveSmallest.java)
- [CVasilijeInCacak.java](./Greedy/CVasilijeInCacak.java)
...
- [ATelephoneNumber.java](./PUCC_CONTEST/PUCC_CONTEST_1/ATelephoneNumber.java)
- [BRoundDownThePrice.java](./PUCC_CONTEST/PUCC_CONTEST_1/BRoundDownThePrice.java)
- [CProfessorGukizSRobot.java](./PUCC_CONTEST/PUCC_CONTEST_1/CProfessorGukizSRobot.java)

#### 📁 [PUCC Contest 2](./PUCC_CONTEST/PUCC_CONTEST_2/) (4 problems)

- [AHulk.java](./PUCC_CONTEST/PUCC_CONTEST_2/AHulk.java)
