...
This repository contains **148** accepted Java solutions for various Codeforces problems, organized by topic.
...
| [Math/](./Math/) | **Math** | **36** | Number theory, divisibility, geometry, formulas, modular arithmetic, ceiling/floor math. |
